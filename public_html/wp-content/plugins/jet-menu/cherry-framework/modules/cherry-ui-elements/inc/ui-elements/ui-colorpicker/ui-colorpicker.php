	...
	class UI_Colorpicker extends UI_Element implements I_UI {
		...
		public static function enqueue_assets() {
			...
			wp_enqueue_script(
				...
				Cherry_Core::base_url( 'inc/ui-elements/ui-colorpicker/assets/min/wp-color-picker-alpha.min.js', Cherry_UI_Elements::$module_path ),
			...
			wp_enqueue_script(
				'ui-colorpicker',
				Cherry_Core::base_url( 'inc/ui-elements/ui-colorpicker/assets/min/ui-colorpicker.min.js', Cherry_UI_Elements::$module_path ),
				array( 'jquery' ),
			...
			wp_enqueue_style(
				'ui-colorpicker',
				Cherry_Core::base_url( 'inc/ui-elements/ui-colorpicker/assets/min/ui-colorpicker.min.css', Cherry_UI_Elements::$module_path ),
				array( 'wp-color-picker' ),
				Cherry_UI_Elements::$core_version,
				'all'
			);
