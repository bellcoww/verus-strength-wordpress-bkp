 ...
 */
add_filter( 'template_include', array( 'Crossarena_Wrapping', 'wrap' ), 99 );
add_filter( 'crossarena_wrap_base', 'crossarena_wrap_base_cpts' );
 ...
 */
function crossarena_template_path() {
	return Crossarena_Wrapping::$main_template;
}
 ...
 */
function crossarena_template_base() {
	return Crossarena_Wrapping::$base;
}

if ( ! class_exists( 'Crossarena_Wrapping' ) ) {
	...
	class Crossarena_Wrapping {
		...
		/**
		 * Initialize new instance of Crossarena_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'crossarena_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Crossarena_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Crossarena_Wrapping();
		}
	}
}
 ...
 */
function crossarena_wrap_base_cpts( $templates ) {
