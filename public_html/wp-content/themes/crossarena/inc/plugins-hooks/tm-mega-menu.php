...
add_filter( 'wp_nav_menu_args', 'crossarena_disable_mega_menu', 1000 );

// Add animation option to tm-mega-menu.
add_filter( 'tm_mega_menu_options', 'crossarena_add_animation_mega_menu_option' );
...
function crossarena_disable_mega_menu( $args ) {
 ...
 * @return array
 */
function crossarena_add_animation_mega_menu_option( $menu_options ) {

	$menu_options['tm-mega-menu-effect']['callback_args']['options']['slide-bottom'] = esc_html__( 'Slide from bottom', 'crossarena' );
