...
if ( ! class_exists( 'UI_Checkbox' ) ) {
	...
	class UI_Checkbox extends UI_Element implements I_UI {
		...
		public static function enqueue_assets() {
			wp_enqueue_script(
				'ui-checkbox',
				Cherry_Core::base_url( 'inc/ui-elements/ui-checkbox/assets/min/ui-checkbox.min.js', Cherry_UI_Elements::$module_path ),
				array( 'jquery' ),
			...
			wp_enqueue_style(
				'ui-checkbox',
				Cherry_Core::base_url( 'inc/ui-elements/ui-checkbox/assets/min/ui-checkbox.min.css', Cherry_UI_Elements::$module_path ),
				array(),
				Cherry_UI_Elements::$core_version,
				'all'
			);
