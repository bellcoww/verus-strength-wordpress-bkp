...
if ( ! class_exists( 'Cherry_Handler' ) ) {
	...
	class Cherry_Handler {
		...
		public function enqueue_scripts() {
			wp_enqueue_script(
				'cherry-handler-js',
				Cherry_Core::base_url( 'assets/js/min/cherry-handler.min.js', $this->module_path ),
				array( 'jquery' ),
				$this->core_version,
				true
			);
			...
			wp_enqueue_style(
				'cherry-handler-css',
				Cherry_Core::base_url( 'assets/css/cherry-handler-styles.min.css', $this->module_path ),
				array(),
				$this->core_version,
				'all'
			);
