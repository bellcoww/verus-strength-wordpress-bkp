...
class Jet_Elements_Portfolio extends Jet_Elements_Base {
	...
	public function get_script_depends() {
		return array( 'imagesloaded', 'jet-magnific-popup', 'jet-masonry-js', 'jet-anime-js' );
	}
	...
	protected function __loop_image_item() {
		...
		return sprintf( '<img class="jet-portfolio__image-instance" src="%1$s" width="%2$s" height="%3$s" alt="">', $params[0], $params[1], $params[2] );
	}
	...
	public function render_filters() {
		...
		$separator_icon = $this->get_settings( 'filters_items_separator_icon' );
		...
		$html .= sprintf( '<div class="jet-portfolio__filter-item active" data-slug="%1$s"><span>%2$s</span></div>', 'all', esc_html__( 'All', 'jet-elements' ) );
	...
	public function generate_category_data() {
		...
		$image_items = $this->get_settings( 'image_list' );
