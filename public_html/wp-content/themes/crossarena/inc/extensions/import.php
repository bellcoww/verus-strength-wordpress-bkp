...
add_filter( 'cherry_data_import_home_regex_replace', 'crossarena_remap_shortcodes' );
add_action( 'cherry_data_import_remap_posts',        'crossarena_remap_menus' );
add_action( 'cherry_data_import_remap_posts',        'crossarena_remap_timetable' );
 ...
 * @return array
 */
function crossarena_remap_shortcodes( $regex ) {
 ...
 */
function crossarena_remap_timetable( $posts ) {
 ...
 * @param array $posts post remapping array.
 */
function crossarena_remap_menus( $posts ) {
