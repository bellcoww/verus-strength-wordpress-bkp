	...
	class UI_Media extends UI_Element implements I_UI {
		...
		public static function enqueue_assets() {
			if ( current_user_can( 'upload_files' ) ) {
				...
				wp_enqueue_script(
					'ui-media',
					Cherry_Core::base_url( 'inc/ui-elements/ui-media/assets/min/ui-media.min.js', Cherry_UI_Elements::$module_path ),
				...
				wp_enqueue_style(
					'ui-media',
					Cherry_Core::base_url( 'inc/ui-elements/ui-media/assets/min/ui-media.min.css', Cherry_UI_Elements::$module_path ),
					array(),
					Cherry_UI_Elements::$core_version,
					'all'
				);
