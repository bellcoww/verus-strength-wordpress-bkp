...
if ( ! class_exists( 'UI_Repeater' ) ) {
	...
	class UI_Repeater extends UI_Element implements I_UI {
		...
		public static function enqueue_assets() {
			wp_enqueue_style(
				'ui-repeater',
				Cherry_Core::base_url( 'inc/ui-elements/ui-repeater/assets/min/ui-repeater.min.css', Cherry_UI_Elements::$module_path ),
				array(),
			...
			wp_enqueue_script(
				'ui-repeater',
				Cherry_Core::base_url( 'inc/ui-elements/ui-repeater/assets/min/ui-repeater.min.js', Cherry_UI_Elements::$module_path ),
