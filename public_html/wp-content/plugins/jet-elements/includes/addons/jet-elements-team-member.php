...
class Jet_Elements_Team_Member extends Jet_Elements_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'    => Controls_Manager::TEXT,
				'default' => esc_html__( 'Position', 'jet-elements' ),
			)
		);
	...
	public function __get_member_image() {
		...
		$format = apply_filters( 'jet-elements/team-member/image-format', '<figure class="jet-team-member__figure"><img class="jet-team-member__img-tag" src="%s" alt=""></figure>' );
