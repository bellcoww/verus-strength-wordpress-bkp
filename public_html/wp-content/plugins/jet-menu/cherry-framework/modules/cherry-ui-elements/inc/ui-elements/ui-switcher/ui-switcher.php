...
if ( ! class_exists( 'UI_Switcher' ) ) {
	...
	class UI_Switcher extends UI_Element implements I_UI {
		...
		public static function enqueue_assets() {
			wp_enqueue_script(
				'ui-switcher',
				Cherry_Core::base_url( 'inc/ui-elements/ui-switcher/assets/min/ui-switcher.min.js', Cherry_UI_Elements::$module_path ),
				array( 'jquery' ),
			...
			wp_enqueue_style(
				'ui-switcher',
				Cherry_Core::base_url( 'inc/ui-elements/ui-switcher/assets/min/ui-switcher.min.css', Cherry_UI_Elements::$module_path ),
				array(),
				Cherry_UI_Elements::$core_version,
				'all'
			);
