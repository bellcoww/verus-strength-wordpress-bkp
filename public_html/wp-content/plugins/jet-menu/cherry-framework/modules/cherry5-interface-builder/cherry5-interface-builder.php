	...
	class Cherry5_Interface_Builder {
		...
		public function enqueue_assets() {
			wp_enqueue_script(
				...
				Cherry_Core::base_url( 'inc/assets/min/cherry-interface-builder.min.js', $this->module_path ),
				array( 'jquery' ),
				$this->core_version,
				true
			);
			wp_enqueue_style(
				'cherry-interface-builder',
				Cherry_Core::base_url( 'inc/assets/min/cherry-interface-builder.min.css', $this->module_path ),
				array(),
				$this->core_version,
				'all'
			);
