...
if ( ! class_exists( 'UI_Slider' ) ) {
	...
	class UI_Slider extends UI_Element implements I_UI {
		...
		public static function enqueue_assets() {
			wp_enqueue_script(
				'ui-slider',
				Cherry_Core::base_url( 'inc/ui-elements/ui-slider/assets/min/ui-slider.min.js', Cherry_UI_Elements::$module_path ),
				array( 'jquery' ),
			...
			wp_enqueue_style(
				'ui-slider',
				Cherry_Core::base_url( 'inc/ui-elements/ui-slider/assets/min/ui-slider.min.css', Cherry_UI_Elements::$module_path ),
				array(),
				Cherry_UI_Elements::$core_version,
				'all'
			);
