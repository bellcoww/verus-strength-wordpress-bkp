...
(function($) {
	...
	CherryJsCore.theme_script = {
		...
		swiper_carousel_init: function(self) {
			...
			jQuery('.crossarena-carousel').each(function() {
				var swiper = null,
		...
		stick_init: function(self) {
			...
			$(window).load(function() {
				...
				if (!$.isFunction(jQuery.fn.stickUp) || undefined === window.crossarena.stickUp || !$navbar.length) {
					return !1;
				}
		...
		isMegaMenuEnabled: function() {
			...
			if (undefined === window.crossarena.megaMenu) {
				return false;
			}

			if (true === window.crossarena.megaMenu.isActive && 'main' == window.crossarena.megaMenu.location) {
				return true;
			}
		...
		main_menu: function(self, $mainNavigation) {
			...
			var transitionend = 'transitionend oTransitionEnd webkitTransitionEnd',
				...
				subMenu,
				index = -1,
				$layout = window.crossarena.labels.header_layout;

			if (hasprop.call(window, 'crossarena') &&
				hasprop.call(window.crossarena, 'more_button_options') &&
				hasprop.call(window.crossarena.more_button_options, 'more_button_type')) {
				switch (window.crossarena.more_button_options.more_button_type) {
					case 'image':
						imgurl = window.crossarena.more_button_options.more_button_image_url;
						if (window.crossarena.more_button_options.retina_more_button_image_url) {
							srcset = ' srcset="' + window.crossarena.more_button_options.retina_more_button_image_url + ' 2x"';
						}
						moreMenuContent = '<img src="' + imgurl + '"' + srcset + ' alt="' + moreMenuContent + '">';
						hasimg = true;
						break;
					case 'icon':
						moreMenuContent = '<i class="fa ' + window.crossarena.more_button_options.more_button_icon + '"></i>';
						hasicon = true;
						break;
					case 'text':
					default:
						moreMenuContent = window.crossarena.more_button_options.more_button_text || moreMenuContent;
						hasimg = false;
						hasicon = false;
						break;
				}
		...
		to_top_init: function(self) {
			if ($.isFunction(jQuery.fn.UItoTop) && undefined !== window.crossarena.toTop) {
				$().UItoTop({
					text: crossarena.labels.totop_button,
					scrollSpeed: 600
				});
			}
		},
				...
				$termItem.on('click', function() {
					var slug = $(this).data('slug'),
						data = {
							...
							nonce: crossarena.new_smart_box_nonce,
							value_slug: slug,
		...
		subscribe_init: function(self) {
			CherryJsCore.variable.$document.on('click', '.subscribe-block__submit', function(event) {
				...
				var $this = $(this),
					...
					nonce = form.find('input[name="crossarena_subscribe"]').val(),
