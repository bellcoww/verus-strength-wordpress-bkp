...
if ( ! class_exists( 'UI_Iconpicker' ) ) {
	...
	class UI_Iconpicker extends UI_Element implements I_UI {
		...
		public static function enqueue_assets() {
			...
			wp_enqueue_style(
				'ui-iconpicker',
				Cherry_Core::base_url( 'inc/ui-elements/ui-iconpicker/assets/min/ui-iconpicker.min.css', Cherry_UI_Elements::$module_path ),
				array(),
			...
			wp_enqueue_script(
				'jquery-iconpicker',
				Cherry_Core::base_url( 'inc/ui-elements/ui-iconpicker/assets/min/jquery-iconpicker.min.js', Cherry_UI_Elements::$module_path ),
				array( 'jquery' ),
				Cherry_UI_Elements::$core_version,
				true
			);
			...
			wp_enqueue_script(
				'ui-iconpicker',
				Cherry_Core::base_url( 'inc/ui-elements/ui-iconpicker/assets/min/ui-iconpicker.min.js', Cherry_UI_Elements::$module_path ),
				array( 'jquery' ),
				Cherry_UI_Elements::$core_version,
				true
			);
