	...
	protected function _register_controls() {
		...
		$css_scheme = apply_filters(
			...
			array(
				...
				'last_top_level_link'          => '.jet-menu > .jet-regular-item:nth-last-child(2) .top-level-link',
				'last_top_level_link_2'        => '.jet-menu > .jet-responsive-menu-available-items:last-child .top-level-link',
				'last_top_level_link_hover'    => '.jet-menu > .jet-regular-item:nth-last-child(2):hover > .top-level-link',
				'last_top_level_link_2_hover'  => '.jet-menu > .jet-responsive-menu-available-items:last-child:hover > .top-level-link',
				'last_top_level_link_active'   => '.jet-menu > .jet-regular-item.jet-current-menu-item:nth-last-child(2) .top-level-link',
				'last_top_level_link_2_active' => '.jet-menu > .jet-responsive-menu-available-items.jet-current-menu-item:last-child .top-level-link',
		...
		$this->add_control(
			...
			array(
				...
				'selectors'   => array(
					'(tablet+){{WRAPPER}} ' . $css_scheme['container'] => 'min-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'(tablet+){{WRAPPER}} ' . $css_scheme['top_level_item'] => 'max-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		foreach( $state_tabs as $tab => $label ) {
			...
			$this->add_group_control(
				...
				array(
					...
					'selector' => '{{WRAPPER}} ' . $css_scheme[ 'last_top_level_link' . $suffix ] . ', {{WRAPPER}} ' . $css_scheme[ 'last_top_level_link_2' . $suffix ],
					'fields_options' => array(
						'border' => array(
		...
		foreach( $level_tabs as $tab => $label ) {
			...
			$this->add_control(
				...
				array(
					...
					'default'   => '',
					'selectors' => array(
						'(mobile){{WRAPPER}} ' . $css_scheme[ $prefix . 'badge' ] => 'display: none;',
					),
				)
			);
