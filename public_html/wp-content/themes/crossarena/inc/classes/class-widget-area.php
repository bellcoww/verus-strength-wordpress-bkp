...
if ( ! class_exists( 'Crossarena_Widget_Area' ) ) {

	/**
	 * Class Crossarena_Widget_Area.
	 */
	class Crossarena_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'crossarena_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'crossarena_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'crossarena_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function crossarena_widget_area() {
		return Crossarena_Widget_Area::get_instance();
	}

	crossarena_widget_area();
}
