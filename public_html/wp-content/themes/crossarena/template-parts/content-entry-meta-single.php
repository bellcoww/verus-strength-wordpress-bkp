...
<div class="entry-meta"><?php
		...
		$author_visible = crossarena_is_meta_visible( 'blog_post_author', 'single' );
		...
		$cats_visible = crossarena_is_meta_visible( 'blog_post_categories', 'single' );
		...
		$tags_visible = crossarena_is_meta_visible( 'blog_post_tags', 'single' );
		$utility->meta_data->get_terms( array(
		...
		$comment_visible = crossarena_is_meta_visible( 'blog_post_comments', 'single' );
