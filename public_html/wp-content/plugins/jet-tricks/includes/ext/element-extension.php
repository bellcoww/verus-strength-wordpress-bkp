	...
	class Jet_Tricks_Element_Extension {
		...
		public function after_common_section_responsive( $obj, $args ) {
			...
			$obj->add_control(
				...
				array(
					'label'   => esc_html__( 'Type', 'jet-tabs' ),
					'type'    => Elementor\Controls_Manager::SELECT,
					'default' => 'text',
					'options' => array(
						'text'  => esc_html__( 'Text', 'jet-tabs' ),
						'image' => esc_html__( 'Image', 'jet-tabs' ),
					),
					'condition' => array(
						'jet_tricks_widget_satellite' => 'true',
					),
			...
			$obj->add_control(
				...
				array(
					...
					'default' => esc_html__( 'Lorem Ipsum', 'jet-tricks' ),
					'condition' => array(
						'jet_tricks_widget_satellite'      => 'true',
						'jet_tricks_widget_satellite_type' => 'text',
					),
		...
		public function column_before_render( $element ) {
			...
			if ( isset( $settings['jet_tricks_column_sticky'] ) ) {
				$column_settings = array(
					...
					'stickyOn'      => isset( $settings['jet_tricks_column_sticky_on'] ) ? $settings['jet_tricks_column_sticky_on'] : array( 'desktop', 'tablet', 'mobile' ),
				);
